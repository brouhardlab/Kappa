...
public class InfoPanel extends JPanel {
    ...
    public InfoPanel() {
        ...
        pointLabel = new JLabel("Point " + KappaFrame.formatNumber(pointSlider.getValue(), BezierCurve.NO_CURVE_POINTS_DIGITS)
    ...
    private class PointChanger implements ChangeListener {
        ...
        public void stateChanged(ChangeEvent ce) {
            pointLabel.setText("Point " + KappaFrame.formatNumber(pointSlider.getValue(), BezierCurve.NO_CURVE_POINTS_DIGITS)
                    + " / " + KappaFrame.UNIT_SCALE);
            KappaFrame.drawImageOverlay();
            repaint();
        }
