...
public class KappaFrame extends JFrame {
    ...
    protected static void setDisplayedChannels(int displayRange) {
        ...
        switch (displayRange) {
            case 0:
                displayedImageStack = new ImagePlus(imageStack.getTitle(), merge.mergeStacks(imageStack.getWidth(), imageStack.getHeight(), imageStack.getNSlices(),
                        null, null, null, true));
    ...
    protected static void enterCurve() {
        ...
        if (inputType == B_SPLINE) {
            ...
            curves.addCurve(points, ControlPanel.currentLayerSlider.getValue(), currCtrlPt, BEZIER_CURVE,
